...
public class ModItems {
    ...
    public static final DeferredItem<HarpoonCrossbowItem> HARPOON_CROSSBOW = ITEMS.registerItem("harpoon_crossbow", (properties) -> new HarpoonCrossbowItem(properties.durability(532).rarity(Rarity.RARE).component(DataComponents.CHARGED_PROJECTILES, ChargedProjectiles.EMPTY).enchantable(1).stacksTo(1)));
